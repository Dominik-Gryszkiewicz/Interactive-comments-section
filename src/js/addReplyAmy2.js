...
export const addReplyAmy2 = () => {
   ...
   if (newCommentContent.value !== "" && newCommentContent.value !== "@amyrobson ") {
      ...
      let newCommentDesktopBox1 = document.createElement("div")
      let newCommentDesktopBox2 = document.createElement("div")
      ...
      newCommentBox.classList.add('component__comment-box', 'component__comment-box--replyAmy', 'd-sm-flex', 'ms-3', 'ms-sm-4', 'ms-md-5')
      newCommentDesktopBox1.classList.add('desktop-box1')
      newCommentDesktopBox2.classList.add('desktop-box2')
      ...
      newCommentBox.appendChild(newCommentDesktopBox1);
      newCommentBox.appendChild(newCommentDesktopBox2);
      newCommentDesktopBox2.appendChild(newCommentBoxTittle);
      newCommentDesktopBox2.appendChild(newCommentBoxContent);
      newCommentDesktopBox2.appendChild(newCommentBoxElements);
